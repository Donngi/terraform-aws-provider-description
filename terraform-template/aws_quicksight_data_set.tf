...
resource "aws_quicksight_data_set" "example" {
  ...
  #   最大項目数: 2048
  #   関連機能: Data Transforms
  #     カラムのキャスト、作成、フィルタ、プロジェクション、リネーム、タグ付け等の
  #     データ変換操作を定義できます。
  #   data_transforms {
  ...
  #       設定可能な値: QuickSightがサポートするフォーマット文字列
  #       省略時: デフォルト値が使用されます。
  #       format = null
  #     }
  ...
  #         設定可能な値: 文字列（データセット更新時に既存カラムと一致すると保持される）
  ...
  #       設定内容: ブール値に評価される式を指定します。
  #       設定可能な値: QuickSightのフィルタ式（trueに評価される行が保持される）
  ...
  #       設定可能な値: カラム名のリスト
  #       projected_columns = ["column1", "column2", "column3"]
  #     }
  ...
  #       tags (Required)
  #       設定内容: データセットカラムタグを定義します（現在は地理空間タイプタグに使用）。
  #       最小項目数: 1
  #       最大項目数: 16
  #       tags {
  ...
  # 最大項目数: 1000
  # 関連機能: Field Folders
  #   データセット内のフィールドを整理し、グループ化するためのフォルダー構造を定義します。
  #   - https://docs.aws.amazon.com/quicksight/latest/APIReference/API_FieldFolder.html
  # field_folders {
  ...
  # 関連機能: Refresh Properties
  #   SPICEデータセットの増分リフレッシュ設定を定義します。
  #   - https://docs.aws.amazon.com/quicksight/latest/APIReference/API_RefreshConfiguration.html
  # refresh_properties {
  ...
  # 最大項目数: 1
  # 関連機能: Data Set Usage Configuration
  #   子データセットがこのデータセットをソースとして使用できるかを制御します。
  #   - https://docs.aws.amazon.com/quicksight/latest/APIReference/API_DataSetUsageConfiguration.html
  ...
  # 関連機能: Column Level Permission Rules
  #   特定のカラムへのアクセスを制限し、ユーザーやグループごとに異なるデータビューを提供します。
  ...
  # 最大項目数: 1
  # 関連機能: Row-Level Security
  #   行レベルでデータへのアクセスを制御し、ユーザーごとに異なるデータサブセットを提供します。
  #   - https://docs.aws.amazon.com/quicksight/latest/APIReference/API_RowLevelPermissionDataSet.html
  ...
  #   設定内容: RLSのパーミッションを含むデータセットに関連付けられたユーザーまたはグループルールを指定します。
  #   設定可能な値: VERSION_1、VERSION_2
  #   省略時: デフォルトのフォーマットバージョンが使用されます。
  #   format_version = null

  #   namespace (Optional)
  #   設定内容: RLSのパーミッションを含むデータセットに関連付けられた名前空間を指定します。
  #   設定可能な値: 文字列
  ...
  # 関連機能: Row-Level Permission Tag Configuration
  #   タグベースの行レベルセキュリティを設定します。
  #   - https://docs.aws.amazon.com/quicksight/latest/APIReference/API_RowLevelPermissionTagConfiguration.html
  ...
  #   tag_rules (Required)
  #   設定内容: タグ名とそれに割り当てられたカラムなど、行レベルセキュリティに関連付けられたルールのセットを定義します。
  #   最小項目数: 1
  #   最大項目数: 50
  #   tag_rules {
  #     column_name (Required)
  ...
  #     設定可能な値: 文字列（値を1つずつリストしたくない場合に使用）
  #     省略時: 使用されません。
  ...
  # 設定内容: データソースのリソースパーミッションのセットを定義します。
  # 最大項目数: 64
  # 関連機能: Resource Permissions
  #   データセットへのアクセス権限を管理し、誰がどのアクションを実行できるかを制御します。
...
#
# - output_columns: データセット内ですべてのデータ準備および変換ステップが
#                   適用された後、分析とダッシュボードで使用可能な最終的な
#                   カラムのセット。以下のプロパティを含みます:
#   - name: カラムの名前
#   - description: カラムの説明
#   - type: カラムのデータ型
#
